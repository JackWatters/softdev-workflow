...
for fuzz_classes, plan, team_size, max_clock_tick, concentration in experimental_parameters:
    try:
        ...
        print >> sys.stderr, e, "encountered during run of",
        print str((fuzz_classes, plan, team_size, max_clock_tick, concentration)), "."
